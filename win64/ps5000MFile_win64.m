function [methodinfo,structs,enuminfo,ThunkLibName]=ps5000MFile_win64
%PS5000MFILE_WIN64 Create structures to define interfaces found in 'ps5000Api'.

%This function was generated by loadlibrary.m parser version  on Tue May  2 14:31:44 2017
%perl options:'ps5000Api.i -outfile=ps5000MFile_win64.m -thunkfile=ps5000_thunk_pcwin64.c -header=ps5000Api.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps5000_thunk_pcwin64');
...
fcns.thunkname{fcnNum}='uint32int16voidPtrvoidPtruint16Thunk';fcns.name{fcnNum}='ps5000GetTriggerTimeOffset64'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int64Ptr', 'enPS5000TimeUnitsPtr', 'uint16'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32int16voidPtrvoidPtruint16uint16Thunk';fcns.name{fcnNum}='ps5000GetValuesTriggerTimeOffsetBulk64'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int64Ptr', 'uint32Ptr', 'uint16', 'uint16'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32int16voidPtrint32Thunk';fcns.name{fcnNum}='ps5000SetEtsTimeBuffer'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'int64Ptr', 'int32'};fcnNum=fcnNum+1;

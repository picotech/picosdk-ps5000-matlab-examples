function [methodinfo,structs,enuminfo,ThunkLibName]=ps5000WrapMFile_glnxa64
%PS5000WRAPMFILE_GLNXA64 Create structures to define interfaces found in 'ps5000Wrap'.

%This function was generated by loadlibrary.m parser version  on Tue May  2 15:29:29 2017
%perl options:'ps5000Wrap.i -outfile=ps5000WrapMFile_glnxa64.m -thunkfile=ps5000Wrap_thunk_glnxa64.c -header=ps5000Wrap.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps5000Wrap_thunk_glnxa64');
...
% extern int16_t SetTriggerProperties ( int16_t handle , int32_t * propertiesArray , int16_t nProperties , int16_t auxEnable , int32_t autoTrig ); 
...
% extern PICO_STATUS setAppAndDriverBuffers ( int16_t handle , int16_t channel , int16_t * appBuffer , int16_t * driverBuffer , uint32_t bufferLength ); 
...
% extern PICO_STATUS setMaxMinAppAndDriverBuffers ( int16_t handle , int16_t channel , int16_t * appMaxBuffer , int16_t * appMinBuffer , int16_t * driverMaxBuffer , int16_t * driverMinBuffer , uint32_t bufferLength ); 
